...
function pokemonCarta($id, $nombre, $imagenTipo, $imagenPokemon, $descripcion, $tipo)
{
    ...
    echo "<img src=$imagenTipo class='w-100 border-end border-2'
                             style='max-height: 155px;' alt=''>";
    echo "</div>";
    echo "<div class='col-6 p-2'>";
    echo "<h6 class='card-title mb-3'>$id # $nombre</h6>";
    echo "<div class='d-block d-flex flex-column'>";
    echo "<img class='col-4 mb-3' src='$imagenPokemon ?>' alt=''>";
